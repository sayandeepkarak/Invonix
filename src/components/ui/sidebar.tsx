...
function SidebarHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      data-sidebar="header"
      className={cn("flex min-h-max flex-col gap-2 px-2 py-6", className)}
      {...props}
    />
  );
}
...
function SidebarContent({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "no-scrollbar flex min-h-0 flex-1 flex-col gap-0 overflow-auto py-5 group-data-[collapsible=icon]:overflow-hidden",
        className,
      )}
      {...props}
    />
